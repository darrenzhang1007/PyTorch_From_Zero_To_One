...
# ============== example 4 ============== #
# create tensor by `torch.zeros_like`
flag = False
# flag = True
if flag:
...
# ============== example 6 ============== #
# create tensor by `torch.full_like`
flag = False
# flag = True
if flag:
    t = torch.tensor([[1, 2, 3], [4, 5, 6]])
...
# ============== example 9 ============== #
# create tensor by `torch.logspace()`
# flag = True
flag = False
if flag:
...
# ============== example 14 ============== #
# create tensor by `torch.randperm()`
# flag = True
flag = False
if flag:
    t = torch.randperm(10)
